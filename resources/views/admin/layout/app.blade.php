                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.teacher') ? 'text-white' : '' }}" href="{{ route('admin.teacher') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>
                                Teachers
                            </a>
                            <a class="nav-link {{ request()->routeIs('admin.settings') ? 'text-white' : '' }}" href="{{route('admin.settings')}}">
