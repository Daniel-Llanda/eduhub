...
<div class="container-fluid px-4">
    <h1 class="mt-4">Favorite Post</h1>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body d-flex flex-column gap-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="mb-0">{{ number_format($post->avg_rating, 1) }}/10</p>
                        </div>
                        ...
                        <p class="fw-bold text-center mt-2">{{ $post->title }}</p>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button class="btn btn-sm p-0 favorite-btn" data-id="{{ $post->id }}" style="background:none; border:none;">
                                    @if($isFavorite)
                                        <!-- Filled favorite -->
